...
namespace G4SBS {
  ...
  // kinematic type
  enum Kine_t   { kElastic, kFlat, kInelastic, kDIS, kBeam, kSIDIS, kGun, kWiser, kPYTHIA6, kSIMC, kSIMC_SIDIS, kGMnElasticCheck, kCosmics, kPionPhoto};
  // experiment type
  // enum Exp_t    { kGEp, kNeutronExp, kSIDISExp, kC16, kA1n, kTDIS, kNDVCS, kGEnRP, kGEMHCtest};
  enum Exp_t    { kGEp, kGMN, kGEN, kSIDISExp, kSIDIS_SIMCExp, kC16, kA1n, kTDIS, kNDVCS, kGEnRP, kGEMHCtest, kGEPpositron, kWAPP, kGEp_BB, kALL };
